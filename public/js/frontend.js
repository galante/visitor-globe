$(function () {
	...
	function render() {
		...
		if (!countriesList.length){
			...
			$('.summary').html(locations.length + ' messages <span>/</span> ' + countriesList.length + ' countries <br> in the past 6 hours');
		...
		locations.forEach(function (a) {
			...
			markers.push(WE.marker([a.latitude, a.longitude]).addTo(earth).bindPopup("An SMS has been sent to <b>" + a.country + '</b>', {maxWidth: 150,maxHeight:100, closeButton: true}));
